...
adjective2 = input("Wait a minute... I think I need a new adjective: ")
...
sentence4 = " In gym, we had to do a " + number + " laps around the track, and I almost passed out."
sentence5 = " By the end of the day, I felt like a " + noun2 + " that had been run over by a bus."
